                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    ...
                    <ul className="menu">
                      <li>
                        <a href="#">
                          <i className="ion ion-ios7-people info" /> 5 new members
                          joined today
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i className="fa fa-warning danger" /> Very long description
                      ...
                      <li>
                        <a href="#">
                          <i className="fa fa-users warning" /> 5 new members joined
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i className="ion ion-ios7-cart success" /> 25 sales made
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i className="ion ion-ios7-person danger" /> You changed
                          your username
                        </a>
                      </li>
                    </ul>
